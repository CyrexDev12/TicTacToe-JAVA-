public class TictactoeLogic {
   ...
   public void printSheet() {
        ...
        for (int i = 0; i < 3; i++) {
         if (board[i][0] == 1 || board[i][0] == 2) {
             if (board[i][0] == 1 && board[i][1] == 1 && board[i][2] == 1) {
                // DEBUG
                System.out.println("Player 1: Has won vertically");
                return 1;
    ...
    public int checkHorizontally() {
        for (int i = 0; i < 3; i++) {
            if (board[i][0] == 1 || board[0][i] == 2) {
                if (board[i][0] == 1 && board[i][1] == 1 && board[i][2] == 1) {
                // DEBUG
                System.out.println("Player 1: Has won horizontally");
                    return 1;
    ...
    public int checkDiagonally() {
        if (board[1][1] == 1 || board[1][1] == 2 ) {
            if (board[1][1] == 1 && (board[0][0] == 1 && board[2][2] == 1) || (board[0][2] == 1 && board[2][0] == 1)) {
                // DEBUG
                System.out.println("Player 1: Has won diagonally");
                return 1;
            } else if (board[1][1] == 2 && (board[0][0] == 2 && board[2][2] == 2) || (board[0][2] == 2 && board[2][0] == 2)) {
                // DEBUG
                System.out.println("Player 2: Has won diagonally");
                return 2;
            }
        }
        return 0;
